          ...
          <Card asChild size='3'>
            <Section id='rental_car'>
                          ...
                          <Grid align='center' columns='60px 1fr' gap='3'>
                            ...
                            <TextField.Root
                              ...
                              {...register(`rental_cars.${i}.region`, {
                                required: isDirtyField('rental_cars') && true
                              })}
                            />
                          </Grid>
                        </Box>
                        ...
                        <Box gridColumn='1 / -1'>
                          <Grid align='center' columns='60px 1fr' gap='3'>
                            ...
                            <Flex align='center' gap='3'>
                              ...
                              <TextField.Root
                                size='3'
                                {...register(`rental_cars.${i}.additional_item_name`)}
                              />
                              <Text wrap='nowrap'>원가</Text>
                              <TextField.Root
                                type='number'
                                size='3'
                                {...register(`rental_cars.${i}.additional_item_cost`, {
                                  valueAsNumber: true
                                })}
                              />
                              <Text wrap='nowrap'>판매가</Text>
                              <TextField.Root
                                type='number'
                                size='3'
                                {...register(`rental_cars.${i}.additional_item_price`, {
                                  valueAsNumber: true
                                })}
                              />
                            </Flex>
              ...
              {isDev() && (
                <pre>
                  {JSON.stringify(
                    { isDirty: isDirtyField('rental_cars'), ...watch('rental_cars') },
                    null,
                    2
                  )}
                </pre>
